...
ps.rowsum.uniqAnimal_biom.spe.fam = subset_samples(ps.rowsum.uniqAnimal_biom.spe,Family == 'Bovidae' |
...
# GENUS
(table(sample_data(ps.rowsum.uniqAnimal_biom.spe)$Genus))
(table(sample_data(ps.rowsum.uniqAnimal_biom.spe)$Genus)[
  table(sample_data(ps.rowsum.uniqAnimal_biom.spe)$Genus) > 4 ])

ps.rowsum.uniqAnimal_biom.spe.gen = subset_samples(ps.rowsum.uniqAnimal_biom.spe, Genus == 'Bos' |
...
table(sample_data(ps.rowsum.uniqAnimal_biom.spe.gen)$Genus)
