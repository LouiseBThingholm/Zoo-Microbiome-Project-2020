...
ps.rowsum = readRDS( file.path(path_data_processed, "Zoo.rowsum_Family.rds"))
ps.rowsum
...
# full host tree of all unique species in dataset
...
# do the matching for our trait data.
