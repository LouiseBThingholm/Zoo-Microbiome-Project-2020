...
ps.count = readRDS( file.path( path_data, "16S_DADA2_processed_African/Zoo.rarefied.count.rds") )
ps.count
# [ 65106 taxa and 576 samples ]
...
# otu_table()   OTU Table:         [  65106 taxa and 527 samples ]
...
dim(alpha.div.matrix.meta) # 527

#  SAVE table of alpha diversities
setwd(path_data)
write.table(alpha.div.matrix.meta, "alpha.div.matrix.meta_Africa.txt", col.names = T, row.names = T, quote = F, sep='\t')
